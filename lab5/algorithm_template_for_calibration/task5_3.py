...
disparity_bm_unrec_norm = cv2.normalize(
    disparity_bm_unrec, None, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_8U
)
disparity_sgm_unrec_norm = cv2.normalize(
    disparity_sgm_unrec, None, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_8U
)
